...
static constexpr auto qt_meta_stringdata_ZN11StartWidgetE = QtMocHelpers::stringData(
    "StartWidget",
    "alertMaxWidth",
    "",
    "changeWidth",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11StartWidgetE[] = {
...
Q_CONSTINIT const QMetaObject StartWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11StartWidgetE.offsetsAndSizes,
    qt_meta_data_ZN11StartWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11StartWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void StartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (StartWidget::*)();
            if (_q_method_type _q_method = &StartWidget::alertMaxWidth; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *StartWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11StartWidgetE.stringdata0))
...
// SIGNAL 0
void StartWidget::alertMaxWidth()
{
